	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/byok", middleware.DisableCache(), controller.GetAllUserByokKeys)
				selfRoute.GET("/byok/status", controller.GetByokStatus)
				selfRoute.POST("/byok", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.CreateUserByokKey)
				selfRoute.PUT("/byok/:id", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.UpdateUserByokKey)
				selfRoute.DELETE("/byok/:id", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.DeleteUserByokKey)
